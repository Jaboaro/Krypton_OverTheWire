...
La resolución de este primer nivel ha sido quizás demasiado sencilla. Vamos a profundicar un poco más en qué estamos haciendo cuando codificamos en `base64`.
...
El decoder se realiza de manera muy similar. Esta programado en mayor detalle en `03-Base64_encoder_decoder.sh`.